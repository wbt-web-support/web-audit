          ...
          {customUrls.map((item, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm font-mono text-blue-700 dark:text-blue-300" title={item.pageLink}>
                  {item.pageLink}
                </span>
                <button
                ...
                <a 
                  ...
                  className="ml-1 p-1 rounded hover:bg-gray-100 dark:hover:bg-gray-800 transition" 
                  title="Open URL"
                >
