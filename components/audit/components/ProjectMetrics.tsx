      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="break-all">{project.base_url}</CardDescription>
          </div>
        </div>
      </CardHeader>
      <CardContent>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 sm:gap-4">
          ...
          <div className={`flex items-center gap-3 p-3 rounded-lg border bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950 hover:shadow-md transition-all ${isCrawling ? 'animate-pulse' : ''}`}>
            <div className="flex-shrink-0">
              {isCrawling ? (
                <Loader2 className="h-5 w-5 sm:h-6 sm:w-6 text-green-500 animate-spin" />
              ) : (
                <Globe className="h-5 w-5 sm:h-6 sm:w-6 text-green-500" />
              )}
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-muted-foreground">Pages Crawled</p>
              <div className="flex items-baseline gap-1">
                <p className="font-semibold text-sm sm:text-lg text-green-600 dark:text-green-400">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg border bg-gradient-to-r from-purple-50 to-violet-50 dark:from-purple-950 dark:to-violet-950 hover:shadow-md transition-all">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-muted-foreground">Pages Analyzed</p>
              <div className="flex items-baseline gap-1">
                <p className="font-semibold text-sm sm:text-lg text-purple-600 dark:text-purple-400">
          ...
          >
            <div className="flex-shrink-0">
              <Eye className="h-5 w-5 sm:h-6 sm:w-6 text-pink-500 group-hover:text-pink-600" />
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-muted-foreground">Total Images</p>
              <div className="flex items-baseline gap-1">
                <p className="font-semibold text-sm sm:text-lg text-pink-600 dark:text-pink-400">
                  {isCrawling 
          ...
          >
            <div className="flex-shrink-0">
              <ExternalLink className="h-5 w-5 sm:h-6 sm:w-6 text-orange-500 group-hover:text-orange-600" />
            </div>
            <div className="min-w-0 flex-1">
              <p className="text-xs sm:text-sm text-muted-foreground">Total Links</p>
              <div className="flex items-baseline gap-1 mb-1">
                <p className="font-semibold text-sm sm:text-lg text-orange-600 dark:text-orange-400">
                  {isCrawling 
